...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ReactDOM = __webpack_require__(1),
	    ...
	    NotesList = __webpack_require__(27);

	ReactDOM.render(React.createElement(NotesList, null), document.getElementById("content"));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	'use strict';var aa=__webpack_require__(4),m=__webpack_require__(14),A=__webpack_require__(6),B=__webpack_require__(8),ca=__webpack_require__(15),da=__webpack_require__(16),ea=__webpack_require__(17),ha=__webpack_require__(18),ia=__webpack_require__(21),C=__webpack_require__(7);
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * LICENSE file in the root directory of this source tree.
	 */
	'use strict';var m=__webpack_require__(6),n=__webpack_require__(7),p=__webpack_require__(8);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("D:\\web-study\\js-traning\\js-apps\\react.js\\to-do-list\\node_modules\\react-hot-api\\modules\\index.js"), RootInstanceProvider = require("D:\\web-study\\js-traning\\js-apps\\react.js\\to-do-list\\node_modules\\react-hot-loader\\RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {

	'use strict';

	var createReactClass = __webpack_require__(30),
	    React = __webpack_require__(4),
	    AddNote = __webpack_require__(28),
	    Note = __webpack_require__(33);
	...
	module.exports = createReactClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            'div',
	            { className: 'add-note' },
	            React.createElement(AddNote, { handleAdd: this.handleAdd }),
	            React.createElement(
	                'table',
	                { className: 'notes-list table' },
	                React.createElement(
	                    'thead',
	                    null,
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'th',
	                            { className: 'note-date-legend' },
	                            'Date'
	                        ),
	                        React.createElement(
	                            'th',
	                            { className: 'note-text-legend' },
	                            'Note'
	                        ),
	                        React.createElement(
	                            'th',
	                            { className: 'note-options-legend' },
	                            ' '
	                        )
	                    )
	                ),
	                React.createElement(
	                    'tbody',
	                    null,
	                    tbody.length ? tbody : React.createElement(
	                        'tr',
	                        null,
	                        React.createElement(
	                            'td',
	                            { className: 'empty-list', colSpan: '3' },
	                            React.createElement(
	                                'i',
	                                null,
	                                'No items here'
	    ...
	    handleAdd: function handleAdd(noteText, noteDate) {
	    ...
	    handleEdit: function handleEdit(index, value) {
	        var list;
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\web-study\\js-traning\\js-apps\\react.js\\to-do-list\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "NotesList.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	...
	module.exports = createReactClass({
	    ...
	    handleSubmit: function handleSubmit(e) {
	        ...
	        if (this.refs.listItemTextInput.value) {
	            this.props.handleAdd(this.refs.listItemTextInput.value, {
	                day: that.state.day,
	    ...
	    handleToggleCalendar: function handleToggleCalendar() {
	        var that = this;
	    ...
	    render: function render() {
	        return React.createElement(
	            'form',
	            { className: 'add-note__form', onSubmit: this.handleSubmit },
	            React.createElement(
	                'fieldset',
	                { className: 'add-note__fieldset well' },
	                React.createElement(
	                    'legend',
	                    { className: 'add-note__legend' },
	                    'Add new note:'
	                ),
	                React.createElement('br', null),
	                React.createElement(
	                    'div',
	                    { className: 'add-note__datepicker', onClick: this.handleToggleCalendar },
	                    React.createElement(
	                        'div',
	                        { className: 'input-group' },
	                        React.createElement(
	                            'div',
	                            { className: 'add-note__date form-control', ref: 'date' },
	                ...
	                this.state.isCalendarVisible ? React.createElement(Datepicker, { setDate: this.setDate, toggleCalendar: this.handleToggleCalendar }) : null,
	                ...
	                React.createElement('input', { className: 'add-note__btn btn btn-primary btn-sm', type: 'submit', value: 'Add' })
	            )
	        );
	    }
	});

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\web-study\\js-traning\\js-apps\\react.js\\to-do-list\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "AddNote.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createReactClass = __webpack_require__(30),
	    React = __webpack_require__(4),
	    monthsList = __webpack_require__(32);
	...
	module.exports = createReactClass({
	    ...
	    handleGetDate: function handleGetDate(date) {
	        var that = this;
	    ...
	    handlePreviousMonth: function handlePreviousMonth(e) {
	        e.preventDefault();
	    ...
	    handleNextMonth: function handleNextMonth(e) {
	        e.preventDefault();
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'calendar popover bottom' },
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'b',
	                        null,
	                        monthsList.monthsNames[this.state.currentMonth],
	                        ', ',
	                        ...
	                        month.map(function (week) {
	                            return React.createElement(
	                                ...
	                                week.map(function (day) {
	                                    return day.month === that.state.currentMonth ? React.createElement(
	                                        'td',
	                                        {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("D:\\web-study\\js-traning\\js-apps\\react.js\\to-do-list\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "Datepicker.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ (function(module, exports) {
	...
	module.exports = {"monthsNames":["January","February","March","April","May","June","July","August","September","October","November","December"]}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = createReactClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'note-text__inner', ref: 'noteText' },
	                    this.props.children
	                ),
	                this.renderTextarea()
	            ),
	            React.createElement(
	                'td',
	                null,
	                React.createElement('span', { className: 'glyphicon glyphicon-edit text-success', onClick: this.handleEdit }),
	                React.createElement(
	                    'span',
	                    null,
	                    '   '
	                ),
	                React.createElement('span', { className: 'glyphicon glyphicon-trash text-danger', onClick: this.handleDelete })
	            )
	        );
	    },
	    ...
	    renderTextarea: function renderTextarea() {
	        ...
	        if (this.state.isEdited) {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    'fieldset',
	                    { className: 'edit-note well' },
	                    React.createElement('textarea', {
	                        className: 'edit-note__input form-control',
	                        defaultValue: this.value,
	                        ref: 'editNoteInput',
	                        autoFocus: true }),
	                    React.createElement('span', { className: 'btn btn-default btn-xs glyphicon glyphicon-ok', onClick: this.handleSaveChanges }),
	                    React.createElement(
	                        'span',
	                        null,
	                        ' '
	                    ),
	                    React.createElement('span', { className: 'btn btn-default btn-xs glyphicon glyphicon-remove', onClick: this.handleCancelChanges })
	                )
	            );
	        } else {
	            if (this.refs.noteText) {
	    ...
	    handleCancelChanges: function handleCancelChanges() {
	        this.setState({
	            isEdited: false
	        });
	    },
